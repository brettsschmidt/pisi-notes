...
export async function NoteBubble({ id, content_md, created_at, tasks }: NoteBubbleProps) {
  ...
  return (
    <article id={`note-${id}`} className="pisi-bubble target:ring-2 target:ring-primary target:ring-offset-2">
